...
class SRDataset(Dataset):
    ...
    def _degrade_bsrgan(self, hr_crop):
        ...
        This removes the fixed Real-ESRGAN operation-order bias by shuffling
        blur, resize, noise, and JPEG before the final LR projection.
        """
        cfg = self.realesrgan_cfg
        s = self._blur_sigma_scale
        target_lr = self.resolution // self.scale
...
# ============================================================================
# PGSR FLUX SR System - 对齐官方流程
# ============================================================================

class DualStreamFLUXSR(nn.Module):
    """
    PGSR FLUX SR System - 使用官方 Scheduler
    """
...
def main():
    parser = argparse.ArgumentParser(description='PGSR FLUX SR Training (full attention)')
    ...
    # Learnable Meta Text Embedding (always ON in train_pgsr.py).
    ...
    train_data_info = {
        ...
        'degradation_cfg': realesrgan_cfg,
        'usm_cfg': usm_cfg,
    ...
    if is_main:
        ...
        print("\n" + "=" * 70)
        print("PGSR FLUX SR Training - full attention")
        print("=" * 70)
        print(f"\nHR Dir: {args.hr_dir}")
    ...
    if is_main:
        with open(log_path, 'w') as f:
            f.write("PGSR FLUX SR Training - full attention\n")
            f.write("=" * 60 + "\n")
